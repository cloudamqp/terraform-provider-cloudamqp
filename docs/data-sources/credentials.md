...
~> **Deprecated** This data source will be removed in next major version (v2.0). Use the credentials attribute in `cloudamqp_instance` resource or data source instead.
